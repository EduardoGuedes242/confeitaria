...
import 'package:confeitaria/pages/vendas/vendas_page.dart';
...
class VendasConstultaPage extends StatelessWidget {
  const VendasConstultaPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const CustomAppBar(title: 'Consultar Vendas'),
      body: Column(
        children: [
          SizedBox(
            height: 180,
